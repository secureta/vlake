...
- **Source:** https://github.com/mitre-attack/attack-stix-data
  (Enterprise / Mobile / ICS STIX bundles:
...
- **License:** MITRE ATT&CK Terms of Use (source repository `LICENSE.txt`)
- **Grant (verbatim):**
  ...
  > in any such copy.
- **Copyright designation:** © 2026 The MITRE Corporation. This work is
  reproduced and distributed with the permission of The MITRE Corporation.
- **Modifications:** Enterprise / Mobile / ICS ATT&CK STIX bundle から主要 SDO
  (technique/tactic/mitigation/group/software/data source 等) と relationship SRO の
  フィールドを抽出し、Parquet に変換している。元 STIX object / relationship は `raw`
  列に保持。
- **Disclaimer:** This project redistributes ATT&CK content but is not endorsed
  or certified by The MITRE Corporation.

## CAPEC (Common Attack Pattern Enumeration and Classification)

- **Source:** https://github.com/mitre/cti/tree/master/capec/2.1
  (CAPEC STIX bundle:
  https://raw.githubusercontent.com/mitre/cti/master/capec/2.1/stix-capec.json)
- **License:** MITRE CAPEC Terms of Use (source repository `LICENSE.txt`)
- **Grant (verbatim):**
  > The MITRE Corporation (MITRE) hereby grants you a non-exclusive,
  > royalty-free license to use Common Attack Pattern Enumeration and
  > Classification (CAPEC™) for research, development, and commercial purposes.
...
- **Modifications:** CAPEC STIX bundle の attack-pattern から主要フィールドを抽出し、
  CWE / ATT&CK 外部参照を配列列として保持して Parquet に変換している。元 STIX object
  は `raw` 列に保持。
- **Disclaimer:** This project redistributes CAPEC content but is not endorsed
  or certified by The MITRE Corporation.
